...
static RT_FUNCTION int beckers(const float3 &v) {
	...
	int rings[] = { 1, 8, 16, 20, 24, 24, 24, 16, 12 };
	...
	int ringsacum[] = { 1, 9, 25, 45, 69, 93, 117, 133, 145 };
	...
	float ringslat[] = { 0.087266462, 0.26179938, 0.43633231, 0.6108652, 0.7853981, 0.9599310, 1.13446401, 1.3089969, 1.5707963 };
